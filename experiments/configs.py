...
grape01.add(*words)
grape01.get_slice().configure(iss_mode="extended")
grape01.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
grape02.add(*words)
grape02.get_slice().configure(iss_mode="extended")
grape02.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
grape03.add(*words)
grape03.get_slice().configure(iss_mode="extended")
grape03.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apple03.get_slice().configure(iss_mode="extended")
...
apple04.get_slice().configure(iss_mode="extended")
...
banana01.add(*words)
banana01.get_slice().configure(iss_mode="extended")
...
banana02.add(*words)
banana02.get_slice().configure(iss_mode="extended")
...
banana03.add(*words)
banana03.get_slice().configure(iss_mode="extended")
...
banana04.add(*words)
banana04.get_slice().configure(iss_mode="extended")
...
banana05.add(*words)
banana05.get_slice().configure(iss_mode="extended")
...
banana06.add(*words)
banana06.get_slice().configure(iss_mode="extended")
...
plantain01.get_slice().configure(iss_mode="extended")
...
plantain02.get_slice().configure(iss_mode="extended")
...
plantain03.get_slice().configure(iss_mode="extended")
...
plantain04.get_slice().configure(iss_mode="extended")
...
plantain05.get_slice().configure(iss_mode="extended")
...
plantain06.get_slice().configure(iss_mode="extended")
...
orange01.add(*words)
orange01.get_slice().configure(iss_mode="extended")
...
orange02.add(*words)
orange02.get_slice().configure(iss_mode="extended")
...
orange03.add(*words)
orange03.get_slice().configure(iss_mode="extended")
...
orange04.add(*words)
orange04.get_slice().configure(iss_mode="extended")
...
tangerine01.get_slice().configure(iss_mode="extended")
...
tangerine02.get_slice().configure(iss_mode="extended")
...
tangerine03.get_slice().configure(iss_mode="extended")
...
tangerine04.get_slice().configure(iss_mode="extended")
...
apricot01.add(*words)
apricot01.get_slice().configure(iss_mode="extended")
apricot01.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot02.add(*words)
apricot02.get_slice().configure(iss_mode="extended")
apricot02.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot03.add(*words)
apricot03.get_slice().configure(iss_mode="extended")
apricot03.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot04.add(*words)
apricot04.get_slice().configure(iss_mode="extended")
apricot04.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot05.add(*words)
apricot05.get_slice().configure(iss_mode="extended")
apricot05.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot06.add(*words)
apricot06.get_slice().configure(iss_mode="extended")
apricot06.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot07.add(*words)
apricot07.get_slice().configure(iss_mode="extended")
apricot07.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
apricot08.add(*words)
apricot08.get_slice().configure(iss_mode="extended")
apricot08.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
...
olive03.add(*words)
olive03.get_slice().configure(iss_mode="extended")
olive03.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.MAX,
...
elderberry01.get_slice().configure(iss_mode="extended")
...
elderberry02.get_slice().configure(iss_mode="extended")
...
elderberry03.get_slice().configure(iss_mode="extended")
...
elderberry04.get_slice().configure(iss_mode="extended")
...
elderberry05.get_slice().configure(iss_mode="extended")
...
for n in range(20):
    ...
    dragonfruit01.get_slice().configure(iss_mode="extended")
    dragonfruit01.add(
        fruits.sieving.PPV,
        fruits.sieving.CPV,
        fruits.sieving.PIA,
...
for left, right in cuts:
    ...
    dragonfruit02.get_slice().configure(iss_mode="extended")
    dragonfruit02.add(
        fruits.sieving.PPV,
        fruits.sieving.CPV,
        fruits.sieving.PIA,
...
for n in ns:
    ...
    dragonfruit03.get_slice().configure(iss_mode="extended")
    dragonfruit03.add(
        fruits.sieving.PPV,
        fruits.sieving.CPV,
        fruits.sieving.PIA,
...
pineapple01.get_slice().configure(iss_mode="extended")
...
pineapple02.get_slice().configure(iss_mode="extended")
...
pineapple03.get_slice().configure(iss_mode="extended")
...
pineapple04.get_slice().configure(iss_mode="extended")
...
pineapple05.get_slice().configure(iss_mode="extended")
...
lychee01.add(*words)
lychee01.get_slice().configure(iss_mode="extended")
...
lychee02.add(*words)
lychee02.get_slice().configure(iss_mode="extended")
...
lychee03.add(*words)
lychee03.get_slice().configure(iss_mode="extended")
...
lychee04.add(*words)
lychee04.get_slice().configure(iss_mode="extended")
...
lychee05.add(*words)
lychee05.get_slice().configure(iss_mode="extended")
...
strawberry.get_slice().configure(iss_mode="extended")
strawberry.add(
    fruits.sieving.PPV,
    fruits.sieving.CPV,
    fruits.sieving.PIA,
