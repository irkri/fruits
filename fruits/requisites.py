...
class Requisite:
    ...
    :class:`~fruits.core.wording.Word` to use.
    ...
    Two Requisite objects are equal if their preparateur and word is
    ...
    def __eq__(self, other) -> bool:
        ...
        if (self._preparateur == other._preparateur
...
class RequisiteContainer:
    ...
    def register(self, requisite_ident: str):
        ...
        """
        if requisite_ident not in self._requisites:
            if requisite_ident not in _AVAILABLE:
